...
class Constants{
    ...
    public static $passwordCharacters = "Your passwords must be between 5 and 30 characters";
    public static $emalInvalid = "Email is invalid";
    ...
    public static $emailInUse = "Email is already registered in on of our accounts";
